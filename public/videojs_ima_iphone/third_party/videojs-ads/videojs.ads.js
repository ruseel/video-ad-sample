...
var
  ...
  // component 시스템을 이용해서 namespace의 Events를 가져온다?
  VIDEO_EVENTS = videojs.getComponent('Html5').Events,


  // 이파일은 대체 무슨 역할을 할까?
  //// player.ads 로만 api를 노출하는 걸까?
  //// 아니면 player.ccancelContentPlay 처럼 노출이 될까?
   ...
   * states.
   *
   * 진짜일까? ima sdk에서 그냥 다 잘 해주는 것은 아니고?
   *
   ...
   * 아... getPlayerSnapshot. flash까지도 저원하고 webvtt를 위해서 있나?
   *   그럴까?
  ...
  adFramework = function(options) {
    ...
    (function() {
      ...
      // 아. 이 코드를 보니 심지어 ima sdk와 vjs-contrib-ads가 같이 잘 도는 건지도 의심스럽구나.
      //  자... 이코드들이 대체 뭘까?
    ...
    fsmHandler = function(event) {
      ...
      // 자... fsm의 키가 상태들이고 전환되면 그래프가 생기는 거다.
      //// 자.. 밥을 먹고 그려보자.
      ////   그래 2~3일에 한 번씩은  웅이 뭔가를 적어놓으면 열받을거라고 생각해야 하는구나.
      ////   왜 답해야 하는 건가?
      ////   뭐가 쌓여 있나?
      ////   
      var fsm = {
